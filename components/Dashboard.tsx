...
import { Part, Notification } from '../types';
...
const Dashboard: React.FC<DashboardProps> = ({ parts, notifications, onViewInventory }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 bg-white p-6 lg:p-8 rounded-[24px] lg:rounded-[32px] border border-slate-200 shadow-sm min-w-0">
          <div className="flex items-center justify-between mb-6 lg:mb-8">
            <div>
              <h3 className="text-lg lg:text-xl font-black text-slate-900">Inventory Equilibrium</h3>
              <p className="text-[10px] lg:text-sm text-slate-500 uppercase font-bold tracking-widest">Levels vs Target Thresholds</p>
            </div>
